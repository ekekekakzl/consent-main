...
"로봇 수술이란?": {
    ...
    "로봇수술의 장점과 단점": {
        ...
        화면을 확대해서 볼 수 있고,<br>로봇 팔이 자유롭게 움직여 <br><span style="color: #007bff;">**정교한 수술**</span>이 가능합니다.|로봇세팅시간이 추가되어<br><span style="color: #dc143c;">**수술 시간이 조금 더**</span> 걸립니다.
        손떨림 없이 미세한 작업이 가능해<br> 주변 혈관이나 신경 <span style="color: #007bff;">**손상을 최소화**</span>할 수 있습니다.|수술 중 문제가 생기면 <br><span style="color: #dc143c;">**배를 열거나 복강경 수술로**</span> 바뀔 수 있습니다.|
    ...
    "수술은 어떻게 진행되나요?": {
        ...
        <br>❸ 카메라와 수술 도구가 들어갈 0.5-1cm 크기의 구멍을 아랫배에 <mark><span style="color: #dc143c;">**2~3개 더**</span></mark> 뚫습니다.(구멍 위치와 개수는 달라질 수 있습니다.)
    ...
    "알아두어야할 점": {
        ...
        - 종양이 크거나 장기가 심하게 달라붙어 있을 것으로 예상되면, 
        <br><mark><span style="color: #dc143c;">**처음부터 배를 여는 수술**</span></mark>을 할 수도 있습니다.

        - 수술 중에 피가 많이 나거나 주변 장기가 다칠 위험이 크다고 판단되면, 
