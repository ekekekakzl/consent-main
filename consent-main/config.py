    ...
    "necessity": [
        {
            ...
            "answer": "O",
            "explanation": "네, 맞아요! 암은 림프절을 따라 전이되는 성질이 최소 침습 수술이라 상처가 작고, 회복도 빨라요. 정말 잘 이해하셨네요! 😊"
        },
        {
            "question": "로봇수술은 개복이나 복강경보다 수술 시간이 짧다는 장점이 있어요. (O/X)",
            "answer": "X",
            "explanation": "아니요, 로봇 수술은 수술을 하기 위해 로봇을 준비하는 시간이 추가적으로 소요되어어 무조건 수술시간이 짧아지는 건 아니에요. 💖"
        }
    ],
    "method": [
        {
            ...
            "answer": "X",
            "explanation": "아니요, 로봇이 스스로 수술하는 것이 아니라, 의사 선생님이 원격으로 로봇 팔을 조종하며 수술하는 거예요. 그래도 의사 선생님이 직접 로봇을 움직이니 걱정하지 마세요! 👍"
        },
        {
            "question": "로봇수술은 아주 작은 부위까지 확대해서 볼 수 있고 삼차원으로 볼 수 있어 더 정교하게 수술할 수 있어요. (O/X)",
            "answer": "O",
            "explanation": "네, 맞아요! 로봇에 달린 카메라를 통해 훨씬 더 자세히 볼 수 있게 도와줘서 수술이 더 섬세하게 진행될 수 있어요. ✨"
        }
    ],
    "considerations": [
        {
            ...
            "answer": "O",
            "explanation": "네, 맞아요! 수술 중 상황에 따라서 수술 진행상황이 바뀔 수 있어요. 환자분의 안전을 위해 의료진이 최선을 다하고, 잘 대처할 준비가 되어 있으니 너무 걱정 마세요. ✨"
        },
        {
            "question": "로봇수술 중에 다른 조직에 손상이 갈 수도 있어요. (O/X)",
            "answer": "O",
            "explanation": "네, 맞아요! 로봇수술 중 떼어내야 할 조직들이 다른 조직에 딱 붙어 있으면, 떼어내는 과정 중에 불가피하게 다른 조직이 손상될 수 있는 가능성이 있어요. 😊"
        }
    ],
    "side_effects": [
        {
            ...
            "answer": "X",
            "explanation": "아니요, 로봇 수술은 아주 작은 확률이라도 합병증이 생길 수 있어요. 하지만 의료진이 합병증을 최소화하기 위해 최선을 다하고, 혹시 생기더라도 잘 대처하면 합병증은 없어질 수 있으니 너무 걱정 마세요. 저희가 함께할 거예요! 💖"
        },
        {
    ...
    "precautions": [
        {
            ...
            "answer": "X",
            "explanation": "아니요, 수술 후에 너무 힘이 많이 드는 운동 시 수술 부위에 무리가 될 수 있어요. 의료진이 알려주는 회복 기간 동안은 무리하지 않고 충분히 쉬어 몸을 회복하는 것이 중요합니다! 🏥"
        },
        {
            "question": "수술 후에는 가벼운 걷기 운동을 하고 숨을 깊고 천천히 쉬는 운동이이 몸이 회복되는 것을 도와주는 것이 좋아요. (O/X)",
            "answer": "O",
            "explanation": "네, 맞아요! 천천히 몸을 움직여주는 것이 회복에 도움이 돼요. 너무 무리하지 않는 선에서 움직여주세요. 또한 전신마취 후 깊고 천천히 숨을 쉬어서 폐가 쪼그라들지 않도록 예방하는 것이 중요해요. 💪"
        }
    ],
    "self_determination": [
        {
            ...
            "answer": "O",
            "explanation": "네, 맞아요! 수술 동의서에는 수술 전, 중, 후에 환자에게 발생할 수 있는 긍정적, 부정적 가능성을 모두 포함하는 내용이 담겨있어야 해요! 🫂"
        },
        {
