...
HARDCODED_BASE_EXPLANATIONS = {
    ...
    "자기결정권": { # <-- 키를 한국어 제목으로 변경
        "_common_explanation": """
        1. 저는 의료진으로부터 이번 수술(또는 시술, 검사, 마취, 진정요법)의 목적, 기대되는 효과, 진행 과정, 생길 수 있는 부작용이나 합병증 등에 대해 설명을 들었습니다.
        2. 이번 수술(또는 시술, 검사, 마취, 진정요법) 중에는 예상하지 못한 사고가 생길 수 있고, 몸의 특이 체질 때문에 문제가 생길 수도 있다는 설명도 이해했습니다.
        3. 저는 이번 수술(또는 시술, 검사, 마취, 진정요법)에 협조하겠으며, 제 건강 상태에 대해 솔직하게 알리겠습니다. 또, 수술 중 필요한 판단은 의료진에게 맡기겠습니다.
        4. 수술(또는 시술, 검사, 마취, 진정요법) 전에 방법이 바뀔 수도 있고, 범위가 넓어질 수도 있다는 설명을 들었고, 이를 이해했습니다.
        5. 수술(또는 시술, 검사, 마취, 진정요법) 전에, 참여하는 의료진이 바뀔 수도 있다는 점과 그 이유에 대한 설명을 들었고, 이를 알고 있습니다.
