...
"왜 수술을 해야 하나요?": {
    ...
    **[수술이 왜 필요한가요?]**
    ...
    "수술은 어떻게 진행되나요?": {
        ...
        |**준비**|수술실로 이동해 환자 정보를 다시 한번 확인한 뒤, 전신 마취를 시작합니다.|
        |---|---|
        |**수술**|❶ 배꼽 주변에 5-12mm 크기의 작은 구멍을 <mark><span style="color: #dc143c;">**6개**</span></mark>를 뚫습니다. <br>❷  이산화탄소 가스를 넣어 배를 부풀려 수술할 공간을 만듭니다.<br>❸ 전립선과 그 주변 조직(정낭, 정관 일부)을 완전히 떼어냅니다. <br>❹ 그다음, **방광과 소변 길(요도)을 다시 연결**합니다. <br>❺ 필요에 따라 골반의 림프절을 함께 제거하거나, 발기에 중요한 신경을 살리는 수술을 같이 할 수 있습니다.|
        |**회복**|마취에서 깨면 회복실로 이동해 상태가 안정될 때까지 지켜본 후, 병실로 돌아옵니다|
    ...
    "합병증": {
        ...
        |**합병증**|**내용**|
        |---|---|
        |**소변 문제<br>(배뇨장애)**|수술 후 <mark><span style="color: #dc143c;">**방광 기능이 떨어져**</span></mark> 소변보기가 어려울 수 있습니다. <br>약물 치료를 하며, 드물게는 오랫동안 지속될 수 있습니다.|
        |**심장/폐 기능 <br>장애**|수술 시 배를 부풀리는 가스 때문에 드물게 발생할 수 있습니다. <br><span style="color: #dc143c;">**어깨가 아플 수**</span> 있지만 보통 하루 안에 좋아집니다.|
        ...
        |**주변 장기 손상**|수술 기구를 뱃속에 넣을 때나, 장기가 심하게 달라붙어 있을 때 주변의 위, 장, 혈관, 방광 등이 <span style="color: #dc143c;">**다칠 수 있습니다.**</span> <br>과거에 수술 받은 경험이 있거나 자궁내막증 등이 있으면 위험이 더 커질 수 있습니다.|
        |**피가 나는 증상(출혈)**|수술 중이나 후에 피가 많이 나면 <span style="color: #007bff;">**수혈**</span>이 필요할 수 있습니다.|
        |**수술 부위 통증**|수술 후 2~5일 정도 아플 수 있으며, 진통제로 조절합니다.|
        |**장이 막히는 증상(장폐색)**|수술 후 <span style="color: #dc143c;">**장이 잘 움직이지 않아**</span> 막힐 수 있습니다. 금식을 하거나 코에 관을 넣어 치료하며, 심하면 재수술이 필요할 수 있습니다.|
        |**상처 감염**|수술 부위에 <span style="color: #dc143c;">**염증**</span>이 생길 수 있습니다. 소독과 항생제로 치료하며, 심하면 입원 기간이 길어지거나 재수술이 필요할 수 있습니다.|
        |**감각이나 운동 <br>기능 저하**|오랜 시간 같은 자세로 수술받기 때문에 신경이 눌려 <span style="color: #007bff;">**팔다리에 감각 이상**</span>이나 마비가 올 수 있습니다. <br>대부분 시간이 지나면 좋아지지만, 드물게는 영구적인 후유증이 남을 수도 있습니다.|
        |**피떡이 혈관을 <br>막는 증상**|다리나 폐, 뇌, 심장 등의 혈관이 피떡(혈전)으로 막힐 수 있습니다.<br>심하면 생명이 위험할 수 있어, 예방을 위해 약을 쓰거나 <span style="color: #007bff;">**압박 스타킹**</span>을 착용합니다.|
        |**눈의 압력 상승<br>(안압 상승)**|수술 자세 때문에 <span style="color: #007bff;">**안압이 올라갈 수**</span> 있습니다. <br>녹내장이 있다면 수술 전에 꼭 알려주세요.|
        ...
        |**소변 길이 좁아지는 문제<br>(방광 경부 협착)**|소변 줄기가 약해지고 소변을 봐도 시원하지 않을 수 있습니다. <br>증상이 심하면 좁아진 길을 넓히는 시술이나 수술이 필요할 수 있습니다.|
