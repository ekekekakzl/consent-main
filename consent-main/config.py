...
"왜 수술을 해야 하나요?": {
    ...
    **[수술이 왜 필요한가요?]**
    ...
    "합병증": {
        ...
        |**합병증**|**내용**|
        |---|---|
        |**소변 문제<br>(배뇨장애)**|수술 후 <mark><span style="color: #007bff;">**방광 기능이 떨어져**</span></mark> 소변보기가 어려울 수 있습니다. <br>약물 치료를 하며, 드물게는 오랫동안 지속될 수 있습니다.|
        |**심장/폐 기능 <br>장애**|수술 시 배를 부풀리는 가스 때문에 드물게 발생할 수 있습니다. <br><span style="color: #007bff;">**어깨가 아플 수**</span> 있지만 보통 하루 안에 좋아집니다.|
