...
"로봇 수술이란?": {
    ...
    - **환자카트**
    <br>: 환자 옆에 위치하며, 카메라와 수술 기구가 달린 <mark><span style="color: #007bff;">**4개의 로봇 팔**</span></mark>이 있습니다.
    - **비전카트**
    ...
    "로봇수술의 장점과 단점": {
        ...
        화면을 확대해서 볼 수 있고,<br>로봇 팔이 자유롭게 움직여 <br><span style="color: #007bff;">**정교한 수술**</span>이 가능합니다.|로봇 세팅 시간이 추가되어<br><span style="color: #dc143c;">**수술 시간이 조금 더**</span> 걸립니다.
        손 떨림 없이 미세한 작업이 가능해<br> 주변의 혈관이나 신경 <span style="color: #007bff;">**손상을 최소화**</span>할 수 있습니다.|수술 중 예상치 못한 문제가 생기면 <br><span style="color: #dc143c;">**배를 열거나 복강경 수술로**</span> 바뀔 수 있습니다.|
        ...
        발기 관련 신경을 살리거나 <span style="color: #007bff;">**방광과 요도를 다시 연결**</span>하는 <br>중요한 과정을 더 <span style="color: #007bff;">**정확하게**</span> 할 수 있습니다.|수술 중 예상치 못한 문제가 생기면<br><span style="color: #dc143c;">**배를 여는 수술로**</span> 바뀔 수 있습니다.|
    ...
    "수술은 어떻게 진행되나요?": {
        ...
        <br>❸ 카메라와 수술 도구가 들어갈 0.5-1cm 크기의 구멍을 아랫배에 <mark><span style="color: #dc143c;">**2~3개 더**</span></mark> 뚫습니다.<br>(구멍 위치와 개수는 달라질 수 있습니다.)
        <br>❹ 떼어낸 자궁 등은 질을 통해 꺼내거나, 잘게 잘라서 꺼냅니다.
        <br>❺ 구멍을 뚫었던 부위를 꿰매고 수술을 마칩니다.
        
        |**수술 시간: 2시간**|**총 소요 시간: 6시간**|
        |---|---|
        |환자의 상태나 유착(장기 등이 달라붙는 현상) 정도에 따라 더 길어질 수 있습니다.|수술 준비부터 회복실을 거쳐 병실로 돌아오는데 걸리는 시간입니다.|
        ...
        """
        ❶ 배꼽 주변에 5-12mm 크기의 작은 구멍을 <mark><span style="color: #dc143c;">**6개**</span></mark>를 뚫습니다. 
        <br>❷  이산화탄소 가스를 넣어 배를 부풀려 수술할 공간을 만듭니다.
        <br>❸ 전립선과 그 주변 조직(정낭, 정관 일부)을 완전히 떼어냅니다. 
        <br>❹ 그다음, <span style="color: #dc143c;">**방광과 소변 길(요도)을 다시 연결**</span>합니다. 
        <br>❺ 필요에 따라 골반의 림프절을 함께 제거하거나, 발기에 중요한 신경을 살리는 수술을 같이 할 수 있습니다.
    ...
    "알아두어야할 점": {
        ...
        <br><mark><span style="color: #dc143c;">**처음부터 배를 여는 수술**</span></mark>을 할 수도 있습니다.

        - 로봇 수술 중에 피가 많이 나거나 주변 장기가 다칠 위험이 크다고 판단되면, 
        <br><mark><span style="color: #dc143c;">**안전을 위해 배를 여는 수술**</span></mark>로 바꿀 수 있습니다.
