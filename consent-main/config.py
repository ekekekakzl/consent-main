    ...
    "necessity": [
        {
            ...
            "answer": "O",
            "explanation": "로봇수술은 최소 침습 수술이라 상처가 작고, 회복도 빨라요. 정말 잘 이해하셨네요! 😊"
        },
        {
            "question": "로봇수술은 꼭 필요한 경우에만 진행되며, 환자분의 상태를 꼼꼼히 확인하고 결정해요. (O/X)",
            "answer": "O",
            "explanation": "어떤 수술이든 환자분께 가장 좋은 방법인지 의료진이 신중하게 판단해서 결정한답니다. 안심하세요! 💖"
        }
    ],
    "method": [
        {
            ...
            "answer": "X",
            "explanation": "의사 선생님은 로봇 팔에 매달리는 게 아니라, 따로 앉아서 로봇 팔을 조종하며 수술하는 거예요. 그래도 의사 선생님이 직접 로봇을 움직이니 걱정하지 마세요! 👍"
        },
        {
            "question": "로봇수술은 사람의 눈으로 볼 수 없는 아주 작은 부위까지 확대해서 볼 수 있어서 더 정교하게 수술할 수 있어요. (O/X)",
            "answer": "O",
            "explanation": "로봇은 사람의 눈보다 훨씬 더 자세히 볼 수 있게 도와줘서 수술이 더 섬세하게 진행될 수 있어요. 정말 똑똑하죠? ✨"
        }
    ],
    "considerations": [
        {
            ...
            "answer": "O",
            "explanation": "금식과 의료진의 지시를 잘 따르면 더 안전하게 수술받을 수 있고 회복도 빨라진답니다. 잘 기억해 주세요! ✨"
        },
        {
            "question": "수술 전에는 건강 상태를 확인하기 위해 피검사나 심전도 검사 같은 여러 검사를 해요. (O/X)",
            "answer": "O",
            "explanation": "환자분께 가장 안전한 수술을 해드리기 위해 몸 상태를 꼼꼼히 확인하는 과정이니 안심하세요. 😊"
        }
    ],
    "side_effects": [
        {
            ...
            "answer": "X",
            "explanation": "모든 수술은 아주 작은 확률이라도 부작용이 생길 수 있어요. 하지만 의료진이 부작용을 최소화하기 위해 최선을 다하고, 혹시 생기더라도 잘 대처할 준비가 되어 있으니 너무 걱정 마세요. 저희가 함께할 거예요! 💖"
        },
        {
    ...
    "precautions": [
        {
            ...
            "answer": "X",
            "explanation": "수술 후에는 몸이 회복될 시간이 필요해요. 의료진이 알려주는 회복 기간 동안은 무리하지 않고 충분히 쉬는 것이 중요해요. 궁금한 점이 있다면 언제든지 저희에게 물어보세요! 🏥"
        },
        {
            "question": "수술 후에는 가벼운 걷기 운동부터 시작해서 몸이 회복되는 것을 도와주는 것이 좋아요. (O/X)",
            "answer": "O",
            "explanation": "천천히 몸을 움직여주는 것이 회복에 도움이 돼요. 너무 무리하지 않는 선에서 움직여주세요. 💪"
        }
    ],
    "self_determination": [
        {
            ...
            "answer": "X",
            "explanation": "동의서에 서명하더라도 수술에 대해 궁금한 점이 있다면 언제든지 물어보고 자세한 설명을 들을 수 있어요. 환자분의 마음이 편안한 것이 가장 중요하답니다! 🫂"
        },
        {
...
FAQ_DATA = {
    ...
    "side_effects": [
        {"question": "1. 수술 후 통증은 얼마나 심한가요?", "answer": "수술 후 통증은 개인차가 있지만, 로봇수술은 최소 침습으로 진행되므로 개복 수술보다 통증이 적은 편입니다. 통증 조절을 위한 약물 치료가 제공됩니다."},
