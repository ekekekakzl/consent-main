...
"로봇 수술이란?": {
    ...
    로봇수술은 <mark>**세 가지**</mark> 장비로 이루어져 있습니다.
    - **콘솔**: 의사가 3D 화면을 보며 로봇 팔을 <mark>**직접**</mark> 조종하여 진행합니다.
    - **환자카트**: 환자 옆에 위치하며, 카메라와 수술 기구가 달린 <mark>**4개의 로봇 팔**</mark>이 있습니다.
    - **비전카트**: 수술 중 의료진 모두가 <mark>**화면을 공유**</mark>할 수 있도록 도와줍니다.
        """,
    ...
    "수술은 어떻게 진행되나요?": {
        ...
        <br>❸ 카메라와 수술 도구가 들어갈 0.5-1cm 크기의 구멍을 아랫배에 2~3개 더 뚫습니다.<br>(구멍 위치와 개수는 달라질 수 있습니다.)
        ...
        <br>❹ 그다음, **방광과 소변 길(요도)을 다시 연결**합니다. 
