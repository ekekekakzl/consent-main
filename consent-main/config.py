...
"로봇 수술이란?": {
    ...
    "수술은 어떻게 진행되나요?": {
        ...
        <br>❸ 카메라와 로봇 팔이 들어갈 0.5-1cm 크기의 구멍을 <br>아랫배에 <mark><span style="color: #dc143c;">**2~3개 더**</span></mark> 뚫습니다.(구멍 위치와 개수는 달라질 수 있습니다.)
        ...
        <br>❷  이산화탄소 가스를 넣어 배를 부풀려 카메라와 로봇 팔이 들어갈 공간을 만듭니다.
