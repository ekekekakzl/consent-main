...
def render_profile_setup():
    ...
    with st.form("profile_form"):
        ...
        # 키를 'surgery_type'으로 사용하도록 수정:
        current_surgery_value = st.session_state.user_profile.get('surgery_type', "선택하세요") 
        ...
        submitted = st.form_submit_button("설명 듣기 시작 >", type="primary")
    ...
    if submitted:
        ...
        if surgery == "선택하세요":
            ...
            st.session_state['user_profile'] = {
                # 키 이름을 'surgery_type'으로 변경하여 section_page.py와 일치시킵니다.
